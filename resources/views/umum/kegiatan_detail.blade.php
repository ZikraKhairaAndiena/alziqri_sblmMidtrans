    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <p class="breadcrumbs">
                    <span class="mr-2"><a href="{{ route('umum.home') }}">Home <i class="ion-ios-arrow-forward"></i></a></span>
                    <span><a href="{{ route('umum.kegiatan') }}">Kegiatan <i class="ion-ios-arrow-forward"></i></a></span>
                    <span>Detail</span>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 ftco-animate">
                <div class="blog-entry align-self-stretch">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('umum.kegiatan') }}" class="btn btn-secondary">&laquo; Kembali ke Daftar Kegiatan</a>
                    </div>
                </div>
            </div>
        </div>
