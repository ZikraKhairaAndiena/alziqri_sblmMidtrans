    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url('{{ asset('images/teacher-1.jpg') }}');">
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url('{{ asset('images/teacher-2.jpg') }}');">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Mitch Parker</h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url('{{ asset('images/teacher-3.jpg') }}');">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Stella Smith</h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url('{{ asset('images/teacher-4.jpg') }}');">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
...
<section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url('{{ asset('images/bg_5.jpg') }}');"
    data-stellar-background-ratio="0.5">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="pricing-entry bg-light active pb-4 text-center">
                    ...
                    <div class="img" style="background-image: url('{{ asset('images/bg_3.jpg') }}');"></div>
                    <div class="px-4">
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                            there live the blind texts.</p>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="pricing-entry bg-light pb-4 text-center">
                    ...
                    <div class="img" style="background-image: url('{{ asset('images/bg_5.jpg') }}');"></div>
                    <div class="px-4">
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                            there live the blind texts.</p>
                    </div>
