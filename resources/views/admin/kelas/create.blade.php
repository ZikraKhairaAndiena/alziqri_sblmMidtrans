...
<div class="card shadow-sm">
    ...
    <div class="card-body">
        <form action="{{ route('admin.kelas.store') }}" method="POST">
            ...
            <!-- Tahun Ajaran -->
            {{-- <div class="mb-3">
                <label for="thn_ajaran_id" class="form-label fw-semibold">
                    Tahun Ajaran <span class="text-danger">*</span>
                </label>
                <select class="form-select @error('thn_ajaran_id') is-invalid @enderror"
                        id="thn_ajaran_id"
                        name="thn_ajaran_id" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_kelas') is-invalid @enderror"
                       id="nama_kelas" name="nama_kelas" value="{{ old('nama_kelas') }}" placeholder="Contoh: Kelas A" maxlength="20" required>
                @error('nama_kelas')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
